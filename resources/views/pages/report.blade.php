<div class="page" id="page-report">
  ...
  <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
    ...
    <div class="flex gap-2">
      <button class="px-4 py-2 bg-emerald-50 text-emerald-700 border border-emerald-200 rounded-full text-xs font-bold hover:bg-emerald-100 transition-colors flex items-center gap-1.5" onclick="SalonApp.exportCSV()">
