<div class="page active" id="page-dashboard">
  <div class="g4">
    <div class="mc">
      <div class="mc-lbl">Pendapatan Hari Ini</div>
      <div class="mc-val" id="d-rev">Rp 0</div>
      <div class="mc-sub">Dari 0 transaksi</div>
    </div>
    <div class="mc">
      <div class="mc-lbl">Pelanggan Hari Ini</div>
      <div class="mc-val" id="d-cust">0</div>
      <div class="mc-sub">Belum ada pelanggan</div>
    </div>
    <div class="mc">
      <div class="mc-lbl">Anggota Aktif</div>
      <div class="mc-val">0</div>
      <div class="mc-sub">Bulan ini</div>
    </div>
    <div class="mc">
      <div class="mc-lbl">Poin Diberikan</div>
      <div class="mc-val">0</div>
      <div class="mc-sub">Hari ini</div>
    </div>
  </div>
  <div class="g2">
    <div class="card">
